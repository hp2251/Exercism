...
public class NaturalNumberTest {
  ...
  public void testThatNonNegativeIntegerIsRejected() {
    IllegalArgumentException expected = assertThrows(IllegalArgumentException.class, () -> new NaturalNumber(0));
  ...
  public void testThatNegativeIntegerIsRejected() {
    IllegalArgumentException expected = assertThrows(IllegalArgumentException.class, () -> new NaturalNumber(-1));
