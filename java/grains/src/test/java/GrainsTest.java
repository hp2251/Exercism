...
public class GrainsTest {
  ...
  public void errorOnNullBoardSize() {
    IllegalArgumentException expected = assertThrows(IllegalArgumentException.class, () -> grains.grainsOnSquare(0));

    assertThat(expected).hasMessage("square must be between 1 and 64");
  }

  @Test
  public void errorOnNegativeBoardSize() {
    IllegalArgumentException expected = assertThrows(IllegalArgumentException.class, () -> grains.grainsOnSquare(-1));
  ...
  public void errorOnExcessiveBoardSize() {
    IllegalArgumentException expected = assertThrows(IllegalArgumentException.class, () -> grains.grainsOnSquare(65));
